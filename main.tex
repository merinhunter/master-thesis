...
En este contexto, este Trabajo de Fin de Máster se centra en el desarrollo de un sistema que facilite el uso de GrimoireLab, primero mediante el estudio e investigación de herramientas ya existentes para este fin, luego mediante el el diseño e implementación de un sistema automatizado de obtención de datos referentes al desarrollo de \emph{software}, y finalmente mediante la integración de este sistema con herramientas de visualización de datos para la construcción de métricas y gráficas que ayuden a comprender mejor este ecosistema.
\end{abstract}
