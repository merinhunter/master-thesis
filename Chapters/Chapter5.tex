...
Estos objetivos se han llevado a cabo de manera satisfactoria. El sistema desarrollado permite el análisis de repositorios \emph{software}\index{software} utilizando un esquema de informes inalterables y con una arquitectura desacoplada entre sus componentes.
